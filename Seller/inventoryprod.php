    ...
    <div id="displayProd">
        <div class="flex">
            ...
            <div class="flex-1 bg-white p-4 shadow-md">
                ...
                <h2 class="text-xl font-semibold mb-4 mt-28">Category</h2>
                <button class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md mb-4"><a
                        href="inventory.php">Back</a></button>
                    ...
                    <div class="modal-content p-4">
                        ...
                        <form @submit="addUserProduct" class="productform">
                            ...
                            <input type="text" placeholder="Total Products" class="mt-1 p-2 w-full border rounded"
                                name="qty">
                            <!-- Total Products -->
                            <input type="text" placeholder="Total Price" class="mt-1 p-2 w-full border rounded"
                                name="price">
                            <!-- Description -->
                            <input type="text" placeholder="Description" class="mt-1 p-2 w-full border rounded"
                                name="desc">
                            <!-- Add Button -->
                    ...
                    <div class="modal-content p-4">
                        ...
                        <form>
                            ...
                            <input type="number" placeholder="Total Products" class="mt-1 p-2 w-full border rounded"
                                name="qty" id="qytUpt">
                            <!-- Total Price -->
                            <input type="number" placeholder="Total Price" class="mt-1 p-2 w-full border rounded"
                                name="price" id="priceUpt">
                            <!-- Update Button -->
                            <div class="d-flex flex-row-reverse">
