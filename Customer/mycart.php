            ...
            <div id="order-details-modal" class="fixed inset-0 z-10 flex items-center justify-center hidden">
                ...
                <div
                    ...
                    <div class="modal-content py-4 text-left px-6 flex-1">
                        ...
                        <div id="order-details-form" v-for="o in orders">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <p>{{ o.name }}, {{ o.email }}, {{ o.permanent_add }} {{ o.contact_no }} </p>
                            </div>
                            ...
                            <table class="w-full border-collapse mb-4">
                                ...
                                <tbody id="order-items">
                                    <tr class="border-b">
                                        <td class="py-2 px-4">
                                            <h3 class="text-lg font-semibold mt-2">{{ o.product_name }}</h3>
                                        </td>
                                        <td class="py-2 px-4">
                                            <div class="flex items-center">
                                                <p>{{ o.quantity }}</p>
                                        ...
                                        <td class="py-2 px-4">{{ o.product_price }}</td>
                                        <td class="py-2 px-4">{{ o.totalPrice }}</td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="payment-method-container flex-1 bg-gray-100 py-4 px-6">
                        ...
                        <div class="text-center">
                            ...
                            <button id="cancel-order-button"
                                class="bg-red-500 text-white py-2 px-4 rounded ml-2 hover:bg-red-600 focus:outline-none">
                                Cancel
                            </button>
                        </div>
