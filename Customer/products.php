                    ...
                    <ul class="flex space-x-4">
                        ...
                        <li>
                            <button id="profile-menu-button"><img
                                    src="/florafusion/assets/img/defaultProfilePicture.jpg" alt="default" width="36"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded shadow-md overflow-hidden">
                <div class="aspect-w-3 aspect-h-4">
                    <!-- Plant Image -->
                    <img :src="'../assets/img/'+plant.image" alt="Plant Product"
                        class="object-cover w-full h-full cursor-pointer" id="openModalButton">
                    ...
                    <div id="plantModal" class="modal">
                        <div class="modal-content">
                            ...
                            <!-- Plant Image -->
                            <img :src="'../assets/img/'+plant.image" alt="Plant Product" class="object-cover w-full h-auto">
                            <!-- Table-like layout for Plant Name, Price, Wishlist, and Add to Cart -->
                            <div class="table">
                                <div class="table-row">
                                    <div class="table-cell">
                                        <h2 class="text-2xl font-semibold" name="name" id="name">{{plant.name}}</h2>
                                    </div>
                                    <div class="table-cell">
                                        <p class="text-lg font-bold text-green-500" name="price" id="price">{{ plnat.price }}</p>
                                    </div>
                                    <div class="table-cell">
                                        <button class="bg-red-500 text-white px-4 py-2 rounded-full" name="wishlist" id="wishlist">Add to
                                            Wishlist</button>
                                    </div>
                                    <div class="table-cell">
                                        <button class="bg-blue-500 text-white px-4 py-2 rounded-full" name="cart" id="cart">Add to
                                            Cart</button>
                                    </div>
                                </div>
                            </div>
                            <!-- Description -->
                            <p class="my-4" name="desc" id="desc">Description: <br> {{ plant.desc }}</p>
                            <!-- Reviews -->
                            ...
                            <div class="border-t border-gray-300">
                                ...
                                <div class="flex items-center my-2" >
                                    ...
                                    <div class="ml-2">
                                        <p class="text-gray-800 font-semibold" name="username" id="username">{{ plant.username }}</p>
                                        <p class="text-gray-600" name="comment" id="comment">{{ plant.comment }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-4" v-for="plant in searchData">
                    <h3 class="text-lg font-semibold mb-2">{{ plant.name }}</h3>
                    <p class="text-gray-600">{{ plant.des }}</p>
                    <div class="mt-2">
                        <span class="text-blue-500 font-semibold">{{ plant.price }}</span>
                        <span class="text-gray-500 ml-2 line-through">{{ plant.price }}</span>
                    </div>
